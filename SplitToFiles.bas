Attribute VB_Name = "SplitToFiles"
Public iMonth As String
Public iYear As String
Public sFilePrefix As String ' Constant
...
sFilePrefix = Application.InputBox("Enter a prefix for the filename. File name will  be Prefix+year+month+[Column Value].xlsx", "Enter Prefix", , , , , , 2)

iCol = Application.InputBox("Enter the column number used for splitting", "Select column", 4, , , , , 1)
...
ActiveWorkbook.Worksheets("Sheet1").ListObjects("Table_Query_from_LTR1LEVSQL01" _
        ).Sort.SortFields.Add Key:=Cells(2, iCol), SortOn:=xlSortOnValues, Order:= _
...
sFilePath = "C:\Users\JWright\Desktop" ' Application.ActiveWorkbook.Path
...
Public Sub CopySheet(osh As Worksheet, iFirstRow As Long, iStartRow As Long, iStopRow As Long, iTotalRows As Long, sFilePath As String, sSectionName As String, fileFormat As XlFileFormat)
     ...
     ash.SaveAs "C:\Users\JWright\Desktop\Split\" + sFilePrefix + iMonth + iYear + sSectionName, fileFormat
